...
<section class="mt-5">
    <div class="container">
        ...
        <div class="caja_servicios">
            <div class="item_caja_servicios">
                <a href="">Marketing y Promociones y Campañas BTL</a>
                <div class="text_hover_servicios">
                    <img src="assets/img/Sin_título-1-17_(1).png" alt="">
                </div>
            </div>
            <div class="item_caja_servicios">
                <a href="">Outsourcing, Procesos & Operaciones</a>
                <div class="text_hover_servicios">
                    <img src="assets/img/Sin_título-1-17_(5).png" alt="">
                </div>
            </div>
            <div class="item_caja_servicios">
                <a href="">Saneamiento Ambiental</a>
                <div class="text_hover_servicios">
                    <img src="assets/img/Sin_título-1-17_(6).png" alt="">
                </div>
            </div>
            <div class="item_caja_servicios">
                <a href="">Consultoría en Gestión Humana</a>
                <div class="text_hover_servicios">
                    <img src="assets/img/Sin_título-1-17_(2).png" alt="">
                </div>
            </div>
            <div class="item_caja_servicios">
                <a href="">Gestión de Recursos Humanos</a>
                <div class="text_hover_servicios">
                    <img src="assets/img/Sin_título-1-17_(3).png" alt="">
                </div>
            </div>
            <div class="item_caja_servicios">
                <a href="">Cooperativa ed Trabajo y Fomento del Empleo</a>
                <div class="text_hover_servicios">
                    <img src="assets/img/Sin_título-1-17_(4).png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active img1_banner">
                <div class="caja_titulo_impulso">
                    <img src="assets/img/Sival_blanco.png" width="35%" alt="">
                    <p class="titulo_impulos_promotorio">Impulso y Promotoría</p>
                    <p class="subtitulo_impulso_promotorio">Redondos - Trujillos 2023</p>
            ...
            <div class="carousel-item img2_banner">
                <div class="caja_titulo_impulso">
                    <img src="assets/img/OSS_blanco.png" width="25%" alt="">
                    <p class="titulo_impulos_promotorio">Operación Constancia</p>
                    <p class="subtitulo_impulso_promotorio">Primax Combustible 2023</p>
                    <div class="btn_solicitar_servicios">
                        <button type="button">Solicitar servicio</button>
                    </div>
                </div>
...
<section class='container mt-5 mb-5'>
    <h3 class='titulo_web'>Lo que nos diferencia</h3>
    <div class='caja_nos_diferencia'>
        <div class='item_nos_diferencia'>
            <div class="cajita_img_diferent"><img src="assets/img/icon_360.png" alt=""></div>
            <br>
            <p>Diseñamos servicios a medida.</p> 
        </div>
        <div class='item_nos_diferencia'>
            <div class="cajita_img_diferent"><img src="assets/img/icon_clientes.png" alt=""></div>
            <br>
            <p>Cuidamos a nuestros clientes, a nuestra gente y sus familias.</p>
            
        </div>
        <div class='item_nos_diferencia'>
            <div class="cajita_img_diferent"><img src="assets/img/icon_integral.png" alt=""></div>
            <br>
            <p>Brindamos un servicio Integral.</p>
        </div>
    </div>
</section>
...
<section class='color_fondo_reconocimientos mt-5 mb-5'>
    <img src="assets/img/banner_reconocimientos.png" width="100%" alt="">
    <!-- <div class="container">
